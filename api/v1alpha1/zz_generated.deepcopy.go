...
func (in *ApplicationSetGenerator) DeepCopyInto(out *ApplicationSetGenerator) {
	*out = *in
	...
	if in.PropList != nil {
		in, out := &in.PropList, &out.PropList
		*out = new(PropListGenerator)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PropListGenerator) DeepCopyInto(out *PropListGenerator) {
	*out = *in
	if in.Elements != nil {
		in, out := &in.Elements, &out.Elements
		*out = make([]PropListGeneratorElement, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PropListGenerator.
func (in *PropListGenerator) DeepCopy() *PropListGenerator {
	if in == nil {
		return nil
	}
	out := new(PropListGenerator)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PropListGeneratorElement) DeepCopyInto(out *PropListGeneratorElement) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PropListGeneratorElement.
func (in *PropListGeneratorElement) DeepCopy() *PropListGeneratorElement {
	if in == nil {
		return nil
	}
	out := new(PropListGeneratorElement)
	in.DeepCopyInto(out)
	return out
}
